...
var prohibited_characters = non_ASCII_space_characters + [
  ...
  for (var i = 0x1d173; i <= 0x1d17a; i++) i /* [MUSICAL CONTROL CHARACTERS] */,
  ...
  for (var i = 0x100000; i <= 0x10fffd; i++) i /* [PRIVATE USE, PLANE 16] */,
  ...
  for (var i = 0x1fffe; i <= 0x1ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x2fffe; i <= 0x2ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x3fffe; i <= 0x3ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x4fffe; i <= 0x4ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x5fffe; i <= 0x5ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x6fffe; i <= 0x6ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x7fffe; i <= 0x7ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x8fffe; i <= 0x8ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x9fffe; i <= 0x9ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0xafffe; i <= 0xaffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0xbfffe; i <= 0xbffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0xcfffe; i <= 0xcffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0xdfffe; i <= 0xdffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0xefffe; i <= 0xeffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  for (var i = 0x10fffe; i <= 0x10ffff; i++) i /* [NONCHARACTER CODE POINTS] */,
  ...
  for (var i = 0x2ff0; i <= 0x2ffb; i++) i /* [IDEOGRAPHIC DESCRIPTION CHARACTERS] */,
